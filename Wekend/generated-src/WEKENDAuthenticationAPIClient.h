 ...
 */
@interface WEKENDAuthenticationAPIClient: AWSAPIGatewayClient
 ...
 *Swift*
     ...
     let serviceClient = WEKENDAuthenticationAPIClient.defaultClient()

 *Objective-C*

     WEKENDAuthenticationAPIClient *serviceClient = [WEKENDAuthenticationAPIClient defaultClient];

 Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `WEKENDAuthenticationAPIClient`.
 ...
 *Swift*
     ...
     func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
         ...
         WEKENDAuthenticationAPIClient.registerClientWithConfiguration(configuration, forKey: "USWest2WEKENDAuthenticationAPIClient")
 ...
 *Swift*
     ...
     let serviceClient = WEKENDAuthenticationAPIClient(forKey: "USWest2WEKENDAuthenticationAPIClient")

 *Objective-C*

     WEKENDAuthenticationAPIClient *serviceClient = [WEKENDAuthenticationAPIClient clientForKey:@"USWest2WEKENDAuthenticationAPIClient"];
...
/**
 ...
 return type: WEKENDGetTokenResponseModel *
 */
...
/**
 ...
 return type: WEKENDLoginResponseModel *
 */
